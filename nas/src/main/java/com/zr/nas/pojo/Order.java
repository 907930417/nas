...
public class Order {
	...
	public Order(String id, int u_id, String order_id, double order_price, String user_name, String user_phone,
			String goods_name, String goods_price, String emp_name, String order_payMethod, String order_state,
			Date order_createdate, String remarks, String location) {
		super();
		this.id = id;
		this.u_id = u_id;
	...
	public String toString() {
		return "Order [id=" + id + ", u_id=" + u_id + ", order_id=" + order_id + ", order_price=" + order_price
				...
				+ ", goods_price=" + goods_price + ", emp_name=" + emp_name + ", order_payMethod=" + order_payMethod
				+ ", order_state=" + order_state + ", order_createdate=" + order_createdate + ", remarks=" + remarks
				+ ", location=" + location + "]";
	}
	public String getId() {
		return id;
